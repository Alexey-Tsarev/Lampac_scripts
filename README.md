...
После окончания серии 3, следующая серия не начинается!
...
## Скрипт
Таким образом всю основную работу делать скрипт [run_player.au3](http://example.com/run_player.au3)
- преобразовывает URL, чтобы скачать `m3u` плейлист
- скачивает `m3u` плейлист
- удаляет в `m3u` плейлисте все ссылки до `index`
